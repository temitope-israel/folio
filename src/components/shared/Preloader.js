...
export default function Preloader({ onComplete }) {
    ...
    // Render
    // --------------------------------------------------------
    return (_jsxs(motion.div, { className: "fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-bg-base", 
        /*
        ...
        */
        ...
        exit: "exit", children: [_jsxs("div", { className: "flex items-end gap-1 mb-8", children: [letters.map((letter, index) => (_jsx(motion.span, { 
                        ...
                        className: "text-[120px] font-bold leading-none text-text-primary font-display", children: letter }, index))), _jsx(motion.span, { variants: letterVariants, 
                        // Inherits from parent — animates in after "I" (200ms later)
                        className: "text-[120px] font-bold leading-none text-brand mb-1", children: "." })] }), _jsx(motion.p, { variants: taglineVariants, 
                ...
                className: "text-text-muted text-sm font-body uppercase", children: personalInfo.title }), _jsx("div", { className: "absolute bottom-0 left-0 right-0 h-[6px] bg-bg-border", children: _jsx("div", { className: "h-full bg-brand", 
                    /*
                    ...
                    */
                    ...
                    } }) }), _jsxs(motion.span, { className: "absolute bottom-4 right-6 text-base  font-mono tabular-nums", 
                /*
                ...
                */
                initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { delay: 0.5, duration: 0.4 }, children: [progress, "%"] })] }));
}
