...
export const projects = [
    ...
    },
    {
        ...
        description: "A premium e-commerce storefront for luxury goods, featuring product catalog, cart, checkout flow with Paystack integration, and order management.",
    ...
    },
    {
        ...
        description: "A two-sided marketplace connecting Nigerian artisans with customers. Features vendor onboarding, product listings, messaging, and Flutterwave payment processing.",
    ...
    },
    {
        ...
        description: "A real-time analytics dashboard with live charts, KPI tracking, CSV export, and role-based access control. Built for business intelligence use cases.",
