...
async function seed() {
  // Clear existing visit data so counts reset to 0
  await prisma.pageVisit.deleteMany({});
  console.log("🗑️ Cleared existing page visits.");

  // If you also want to reset messages to 0:
  // await prisma.message.deleteMany({});
  // console.log("🗑️ Cleared existing messages.");

  console.log("✅ Page visits reset to 0. Real traffic will populate analytics.");
